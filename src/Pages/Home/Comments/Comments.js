                ...
                <div className='relative md:border-l text-left border-gray-200'>
                    <div className="">
                        <div className="mb-6 md:ml-4">
                            <label htmlFor="message" className="block mb-2 mt-2 text-md font-medium text-gray-900 ">Your message</label>
                        <p className='text-sm text-slate-500 mb-2'>Share your feelings or experience about your mentor SMART GYM TRAINER</p>
                        <textarea id="message" rows="8" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-400 focus:border-blue-400 " placeholder="Leave your comment..."></textarea>
