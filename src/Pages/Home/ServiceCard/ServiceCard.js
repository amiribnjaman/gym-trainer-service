            ...
            <div class="relative max-w-sm min-h-full bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div className='rounded-md'>
                    ...
                    <div className='px-4 py-5'>
                        ...
                        <div>
                            <Link to="#" class="left-1/2 inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:ring-0 focus:outline-none">
                                Explore now
