...
const ServiceCard = ({ service }) => {
    ...
    return (
        <div className='mx-auto'>
            <div className="relative max-w-sm min-h-full bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div className='rounded-md'>
                    ...
                    <div className='px-4 py-5'>
                        ...
                        <p className="mb-3 font-normal text-gray-600 dark:text-gray-500 text-[14px]">{desc}</p>
                        <h5 className='text-md text-black font-semibold my-2'>${price}/ <span className='text-sm font-thin'>month</span></h5>
                        <div className='mt-4'>
                            <Link to="/checkout" className="left-1/2 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:ring-0 focus:outline-none">
                                Explore now
