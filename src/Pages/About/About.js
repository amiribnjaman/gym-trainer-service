...
const About = () => {
    return (
        <div className='md:flex md:w-4/6 mx-auto my-10 md:my-20'>
            ...
            <div className='ml-2'>
                <div class="relative md:border-l border-gray-200 ">
                    <div class="mb-10 ml-4 text-left">
                        <div class="absolute md:w-3 md:h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                        <h3 class="text-lg font-semibold text-gray-900 ">AMIR HOSEN</h3>
                        <h4 class="text-MD font-semibold text-gray-800 ">Front-end Developer</h4>
                        <p class="mb-4 text-sm font-normal text-slate-500 w-11/12">
                            Hello Buddy, <br />
