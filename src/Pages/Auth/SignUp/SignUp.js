    ...
    return (
        <div className='md:w-1/4 sm:w-1/2 w-11/12 mx-auto mt-2 mb-32  min-h-full'>
            <div>
                ...
                <h4 className='text-red-500 text-center mt-1 text-[15px]'>{customGoogleErr && customGoogleErr}</h4>
                <div className='shadow-lg px-7 rounded-md pb-6 mt-3'>
                    <form
                    ...
                    >
                        ...
                        <h4 className='text-red-600 text-[14px] ml-3 font-semibold text-left'>{userError?.others && userError?.others}</h4>
